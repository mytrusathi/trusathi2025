  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-100 pt-10 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 bg-white rounded-3xl p-8 border border-brand-gold-500/10 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6 text-left max-w-2xl">
            <div className="w-16 h-16 bg-brand-navy-900 rounded-2xl flex items-center justify-center text-brand-gold-500 shrink-0">
              <Handshake size={32} />
            </div>
            <div>
          ...
          <div className="flex gap-4 shrink-0">
            <div className="px-5 py-3 bg-brand-gold-500/5 rounded-2xl text-brand-gold-600 font-black text-sm uppercase tracking-wider flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2 lg:col-span-1">
            ...
            <Link href="/" className="flex items-center gap-3 mb-8 group">
              <div className="w-10 h-10 bg-brand-navy-900 rounded-xl flex items-center justify-center text-brand-gold-500 shadow-lg shadow-slate-200 group-hover:scale-110 transition-transform">
                <Handshake size={20} />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-slate-500">
              <li><Link href="/search?role=Bride" className="hover:text-brand-gold-600 transition-colors">Browse Brides</Link></li>
              <li><Link href="/search?role=Groom" className="hover:text-brand-gold-600 transition-colors">Browse Grooms</Link></li>
              <li><Link href="/communities" className="hover:text-brand-gold-600 transition-colors">Authentic Groups</Link></li>
              <li><Link href="/success-stories" className="hover:text-brand-gold-600 transition-colors">Our Mission</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-slate-500">
              <li><Link href="/support" className="hover:text-brand-gold-600 transition-colors">Help Center &amp; FAQ</Link></li>
              <li><Link href="/support#safety" className="hover:text-brand-gold-600 transition-colors">Safety Tips</Link></li>
              <li><Link href="/about" className="hover:text-brand-gold-600 transition-colors">Why TruSathi?</Link></li>
              <li className="flex items-center gap-2 pt-2">
                <Mail size={16} className="text-slate-400" />
                <a href="mailto:support@trusathi.com" className="text-brand-gold-500 hover:underline">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-slate-500">
              <li><Link href="/terms" className="hover:text-brand-gold-600 transition-colors">Terms of Service</Link></li>
              <li><Link href="/privacy" className="hover:text-brand-gold-600 transition-colors">Privacy Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-8">
            <VisitorCounter />
            <div className="flex items-center gap-2 px-4 py-2 bg-brand-navy-900 text-white rounded-full shadow-lg shadow-slate-100">
...
function SocialIcon({ icon }: { icon: React.ReactNode }) {
  return (
    <a href="#" className="w-11 h-11 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-brand-gold-600 hover:border-brand-gold-500/20 hover:shadow-xl hover:shadow-brand-gold-500/20 transition-all hover:-translate-y-1">
      {icon}
    </a>
  );
}