...
export default function GroupAdminCTA() {
  return (
    <section className="py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-[linear-gradient(135deg,var(--brand-navy-900)_0%,var(--brand-navy-800)_50%,var(--brand-navy-700)_100%)] rounded-[3.5rem] p-10 md:p-24 text-center md:text-left relative overflow-hidden shadow-3xl shadow-slate-200/20 group border border-white/5">

        {/* Animated Background Orbs - Updated to Amber/Gold */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-gold-500/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 group-hover:bg-brand-gold-500/20 transition-colors duration-1000"></div>
        ...
        <div className="relative z-10 lg:flex items-center justify-between gap-16">
          ...
          <div className="space-y-8 max-w-2xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-brand-gold-400 text-[10px] font-black uppercase tracking-[0.2em] backdrop-blur-md">
              <Zap size={14} className="fill-brand-gold-500 text-brand-gold-500" /> Empower Your Community
            </div>
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold-400 to-brand-gold-400/50">Community Leader?</span>
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 justify-center md:justify-start">
              <div className="flex items-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-wider">
                <ShieldCheck size={16} className="text-brand-gold-500/60" /> Data Integrity
              </div>
              <div className="flex items-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-wider">
                <Star size={16} className="text-brand-gold-500/60" /> Professional Dashboard
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 lg:mt-0 flex flex-col sm:flex-row lg:flex-col gap-4 w-full md:w-auto shrink-0">
            ...
            <Link href="/register"
              className="group/btn relative px-10 py-5 bg-brand-gold-500 text-slate-950 font-black rounded-2xl shadow-2xl hover:bg-brand-gold-400 transition-all flex items-center justify-center gap-3 active:scale-95 overflow-hidden text-center"
            >
